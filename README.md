...
**LADDER** is a Python package for generating datasets for RL. It uses LLMs to generate easier sub-problems of base problems, essentially achieving hierarchical RL by creating a tree of problem difficulties. Based on the [LADDER paper](https://arxiv.org/abs/2503.00735).
